 ...
 */
public class QTMovieMaker implements StdQTConstants
	{	
	/** Available codecs */
	 ...
	 */
	public QTMovieMaker(String path, int finalWidth, int finalHeight, String codec, String quality) throws Exception
		{
