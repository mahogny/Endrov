 ...
 */
public class MakeMovieDescriptionFormat
	{
	private String desc;
	
	
	public MakeMovieDescriptionFormat(String s)
		{
		desc=s;
		}
...
//		System.out.println("-"+cs.decode()+"-");
		MakeMovieDescriptionFormat cs=new MakeMovieDescriptionFormat("<channel/> (<frame/>) <> <time sf=\"1000\" st=\"0\"/>");
