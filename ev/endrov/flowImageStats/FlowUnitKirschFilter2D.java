 ...
 *
 */
public class FlowUnitKirschFilter2D extends FlowUnitBasic
	{
	...
	static
		{
		Flow.addUnitType(new FlowUnitDeclaration(CategoryInfo.name,showName,metaType,FlowUnitKirschFilter2D.class, null,
				"Detect maximum edge intensity"));
		}
