 ...
 *
 */
public class FlowUnitBinMorphThin2D extends FlowUnitBasic
	{
	public static final String showName="Binary Thinen 2D";
	private static final String metaType="binaryThin2d";
	
	public static void initPlugin() {}
	static
		{
		Flow.addUnitType(new FlowUnitDeclaration(CategoryInfo.name,showName,metaType,FlowUnitBinMorphThin2D.class, null,
