...
public class HyBRDoubleIterativeDeconvolver2D extends DoubleIterativeDeconvolver2D {
     ...
     *            HyBR options
     */
    public HyBRDoubleIterativeDeconvolver2D(EvPixels imB, EvPixels[][] imPSF, PreconditionerType preconditioner, double preconditionerTol, BoundaryType boundary, ResizingType resizing, int maxIters, boolean showIteration, HyBROptions options) {
        super("HyBR", preconditioner, preconditionerTol, boundary, resizing, options.getUseThreshold(), options.getThreshold(), maxIters, showIteration, options.getLogConvergence());
