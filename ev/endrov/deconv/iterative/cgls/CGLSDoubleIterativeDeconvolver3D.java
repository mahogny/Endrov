 ...
 */
package endrov.deconv.iterative.cgls;

import cern.colt.matrix.tdouble.DoubleMatrix3D;
import cern.jet.math.tdouble.DoubleFunctions;
import endrov.deconv.DeconvPixelsStack;
import endrov.deconv.iterative.DoubleIterativeDeconvolver3D;
import endrov.deconv.iterative.DoubleCommon2D;
import endrov.deconv.iterative.DoubleCommon3D;
 ...
 * 
 */
public class CGLSDoubleIterativeDeconvolver3D extends DoubleIterativeDeconvolver3D {
     ...
     *            CGLS options
     */
    public CGLSDoubleIterativeDeconvolver3D(EvStack imB, EvStack[][][] imPSF, PreconditionerType preconditioner, double preconditionerTol, BoundaryType boundary, ResizingType resizing, int maxIters, boolean showIteration, CGLSOptions options) {
        super("CGLS", imB, imPSF, preconditioner, preconditionerTol, boundary, resizing, options.getUseThreshold(), options.getThreshold(), maxIters, showIteration, options.getLogConvergence());
        this.autoStoppingTol = options.getAutoStoppingTol();
        this.stoppingTol = options.getStoppingTol();
    }

    public DeconvPixelsStack internalDeconvolve() {
