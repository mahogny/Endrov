...
public class CGLSDoubleIterativeDeconvolver2D extends DoubleIterativeDeconvolver2D {
     ...
     *            CGLS options
     */
    public CGLSDoubleIterativeDeconvolver2D(EvPixels imB, EvPixels[][] imPSF, PreconditionerType preconditioner, double preconditionerTol, BoundaryType boundary, ResizingType resizing, int maxIters, boolean showIteration, CGLSOptions options) {
        super("CGLS", preconditioner, preconditionerTol, boundary, resizing, options.getUseThreshold(), options.getThreshold(), maxIters, showIteration, options.getLogConvergence());
