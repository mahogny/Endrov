 ...
 */
package endrov.deconv.iterative.mrnsd;

import cern.colt.list.tdouble.DoubleArrayList;
import cern.colt.list.tint.IntArrayList;
import cern.colt.matrix.tdouble.DoubleMatrix2D;
import cern.jet.math.tdouble.DoubleFunctions;
import endrov.deconv.iterative.DoubleIterativeDeconvolver2D;
 ...
 * 
 */
public class MRNSDDoubleIterativeDeconvolver2D extends DoubleIterativeDeconvolver2D {
     ...
     *            MRNSD options
     */
    public MRNSDDoubleIterativeDeconvolver2D(EvPixels imB, EvPixels[][] imPSF, PreconditionerType preconditioner, double preconditionerTol, BoundaryType boundary, ResizingType resizing, int maxIters, boolean showIteration, MRNSDOptions options) {
        super("MRNSD", preconditioner, preconditionerTol, boundary, resizing, options.getUseThreshold(), options.getThreshold(), maxIters, showIteration, options.getLogConvergence());
