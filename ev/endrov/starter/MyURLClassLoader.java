...
/**
 * This is a modified URLClassLoader.
 * 
 * @author  David Connelly, Johan Henriksson
 */
public class MyURLClassLoader extends SecureClassLoader {
    ...
    public URL findResource(final String name) {
         ...
         */
        URL url =
            (URL) AccessController.doPrivileged(new PrivilegedAction<Object>() {
                public Object run() {
    ...
    public static MyURLClassLoader newInstance(final URL[] urls,
        ...
        MyURLClassLoader ucl =
            (MyURLClassLoader) AccessController.doPrivileged(new PrivilegedAction<Object>() {
                public Object run() {
    ...
    public static MyURLClassLoader newInstance(final URL[] urls) {
        ...
        AccessControlContext acc = AccessController.getContext();
        // Need a privileged block to create the class loader
        MyURLClassLoader ucl = (MyURLClassLoader)
            AccessController.doPrivileged(new PrivilegedAction<Object>() {
                public Object run() {
    ...
    static {
        sun.misc.SharedSecrets.setJavaNetAccess (
            new sun.misc.JavaNetAccess() {
                public URLClassPath getURLClassPath (MyURLClassLoader u) {
                    return u.ucp;
                }
            }
        );
