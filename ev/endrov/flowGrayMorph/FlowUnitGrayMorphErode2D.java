 ...
 *
 */
public class FlowUnitGrayMorphErode2D extends FlowUnitBasic
	{
	...
	static
		{
		Flow.addUnitType(new FlowUnitDeclaration(CategoryInfo.name,showName,metaType,FlowUnitGrayMorphErode2D.class, null,
				"Gray morphological erode operation, slice by slice"));
		}
