...
public class MakeMovieWindowFromViewer2D extends EvBasicWindow implements ActionListener
	...
	private final List<EncodeMovieThread.MovieChannel> channelNames;
	 ...
	 */
	public MakeMovieWindowFromViewer2D(List<EncodeMovieThread.MovieChannel> channelNames, File suggestFileName)
		{
	...
	public void actionPerformed(ActionEvent e)
		...
		if(e.getSource()==codecCombo)
			...
			if(textBad!=null)
				...
				{					
				for(int i=0;i<channelNames.size();i++)
					channelNames.get(i).desc=new EncodeMovieDescriptionFormat(chanDesc.get(i).getText());
