 ...
 */
public class NetworkModelExtension implements Viewer3DWindowExtension
	{
  ...
  public void newModelWindow(Viewer3DWindow w)
	...
	static class NetworkModelWindowHook implements Viewer3DHook, ActionListener
		{
		...
		public NetworkModelWindowHook(final Viewer3DWindow w)
			{
			this.w=w;
...
/*		private int displayListVisibleSphere;
	...
	static
		{
		Viewer3DWindow.modelWindowExtensions.add(new NetworkModelExtension());
		}
