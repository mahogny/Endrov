...
public class DoubleReflexiveTruncatedSVD2D extends AbstractDoubleSpectralDeconvolver2D {
     ...
     */
    public DoubleReflexiveTruncatedSVD2D(EvPixels imB, EvPixels imPSF, ResizingType resizing, double regParam, double threshold) {
        super("TSVD", imB, imPSF, resizing, PaddingType.REFLEXIVE, regParam, threshold);
    }
