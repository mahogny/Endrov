 ...
 *
 */
public class OpDeconvolveTikhonov2D extends Deconvolver2D
	{
	...
	private final SpectralPaddingType padding;
	 ...
	 public OpDeconvolveTikhonov2D(EvPixels imPSF, SpectralResizingType resizing,double regParam, double threshold, SpectralPaddingType padding) 
		 {
		 this.imPSF=imPSF;
