...
public class DoublePeriodicTikhonov2D extends AbstractDoubleSpectralDeconvolver2D {
     ...
     */
    public DoublePeriodicTikhonov2D(EvPixels imB, EvPixels imPSF, ResizingType resizing, double regParam, double threshold) {
        super("Tikhonov", imB, imPSF, resizing, PaddingType.PERIODIC, regParam, threshold);
    }
