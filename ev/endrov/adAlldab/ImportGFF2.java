...
public class ImportGFF2
				...
				while(sta.hasMoreTokens())
					...
					if(!at.equals(""))
						...
						if(at.startsWith("Target"))
							...
							gff.desc=at;
						else if(at.startsWith("GenBank"))
							gff.desc=at;
						else if(at.startsWith("Sequence"))
							gff.desc=at;
						else if(at.startsWith("Locus"))
							gff.desc=at;
	...
	/*
						if(at.startsWith("Target "))
							gff.desc=getUntilCitation(at.substring(7));
						else if(at.startsWith("CDS "))
							gff.desc=getUntilCitation(at.substring(4));
						else if(at.startsWith("Confirmed_EST ") && gff.desc==null)
							gff.desc=at.substring(14);
						else if(at.startsWith("Gene "))
							gff.desc=at.substring(6);
						else if(at.startsWith("GenBank "))
							gff.desc=at.substring(9);
						else if(at.startsWith("Sequence "))
							gff.desc=at.substring(10);
						else if(at.startsWith("Locus "))
							gff.desc=at.substring(6);
						else if(at.startsWith("Target ") && gff.desc==null)
							gff.desc=getUntilCitation(at.substring(7));
...
*/
	...
	public static void main(String[] args)
		...
		try 
			...
			final PreparedStatement psSeqannot=db.conn.prepareStatement("INSERT INTO seqannot (startpos,endpos,seqid,sourceid,featureid,annotid,seqdesc) VALUES (?,?,?,?,?,?,?);");
...
//					System.out.println("- "+gff.seqname+"\t"+gff.feature+"\t"+gff.start+"\t"+gff.end);
					...
					try
						...
						psSeqannot.setString(7, gff.desc);
						psSeqannot.addBatch();
						...
						annotid++;
						if(annotid%1000==0) //no gain over this number
							{
