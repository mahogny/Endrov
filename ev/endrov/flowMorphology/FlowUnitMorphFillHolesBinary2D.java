 ...
 *
 */
public class FlowUnitMorphFillHolesBinary2D extends FlowUnitBasic
	{
	...
	static
		{
		Flow.addUnitType(new FlowUnitDeclaration(CategoryInfo.name,showName,metaType,FlowUnitMorphFillHolesBinary2D.class, CategoryInfo.icon,
