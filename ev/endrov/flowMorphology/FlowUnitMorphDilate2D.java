 ...
 *
 */
public class FlowUnitMorphDilate2D extends FlowUnitBasic
	{
	...
	static
		{
		Flow.addUnitType(new FlowUnitDeclaration(CategoryInfo.name,showName,metaType,FlowUnitMorphDilate2D.class, CategoryInfo.icon,
				"Morphological dilate operation, slice by slice"));
		}
	...
	public void evaluate(Flow flow, FlowExec exec) throws Exception
		...
		lastOutput.put("out", new EvOpMorphDilate2D(kernel).exec1Untyped(exec.ph, a));
		}
