 ...
 *
 */
public class FlowUnitMorphOpen2D extends FlowUnitBasic
	{
	...
	static
		{
		Flow.addUnitType(new FlowUnitDeclaration(CategoryInfo.name,showName,metaType,FlowUnitMorphOpen2D.class, CategoryInfo.icon,
				"Morphological open operation, slice by slice"));
		}
	...
	public void evaluate(Flow flow, FlowExec exec) throws Exception
		...
		lastOutput.put("out", new EvOpMorphOpen2D(kernel).exec1Untyped(exec.ph, a));
		}
