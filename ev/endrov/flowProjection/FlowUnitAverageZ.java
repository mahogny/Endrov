 ...
 *
 */
public class FlowUnitAverageZ extends FlowUnitBasic
	{
	...
	static
		{
		Flow.addUnitType(new FlowUnitDeclaration(CategoryInfo.name,showName,metaType,FlowUnitAverageZ.class, null,
