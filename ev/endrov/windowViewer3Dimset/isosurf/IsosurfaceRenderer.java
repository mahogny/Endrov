...
public class IsosurfaceRenderer
	...
	public void uploadData(Viewer3DView view, FloatBuffer vertb, FloatBuffer vertn, IntBuffer indb)
		{
		this.vertb=vertb;
		this.vertn=vertn;
		this.indb=indb;
	...
	public Collection<BoundingBox3D> adjustScale(Viewer3DWindow w)
		{
		return Collections.singleton(new BoundingBox3D(minX,maxX, minY,maxY, minZ,maxZ));
		}
	 ...
	 * Render surface
	 */
	public void render(GL glin,List<TransparentRenderer3D> transparentRenderers, EvGLCamera cam, final float red, final float green, final float blue, final float trans)
		{
		GL2 gl=glin.getGL2();
		...
		if(vertb!=null || hasVBO)
			...
			IsosurfRenderState renderState=new IsosurfRenderState(){
				...
				public boolean optimizedSwitch(GL glin, TransparentRenderer3D.RenderState currentState)
					{
					GL2 gl=glin.getGL2();
