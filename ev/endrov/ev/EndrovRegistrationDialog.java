 ...
 *
 */
public class EndrovRegistrationDialog extends JDialog implements ActionListener
	{
	...
	public EndrovRegistrationDialog()
		{
		setTitle(EV.programName + " Registration");
	...
	public static void runDialog()
		{
		EndrovRegistrationDialog use=new EndrovRegistrationDialog();
		try
			{
			use.lock.acquire();
			}
	...
	static
	{
	EV.personalConfigLoaders.put("evregistration", new PersonalConfig()
		{
