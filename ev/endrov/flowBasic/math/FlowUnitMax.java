...
public class FlowUnitMax extends FlowUnitMathBinop
	...
	public void evaluate(Flow flow, FlowExec exec) throws Exception
		...
		if(a instanceof Number && b instanceof Number)
			...
			lastOutput.put("C", new EvOpImageMaxScalar((Number)b).exec1Untyped((AnyEvImage)a));
		else if(b instanceof AnyEvImage && a instanceof Number)
			lastOutput.put("C", new EvOpImageMaxScalar((Number)a).exec1Untyped((AnyEvImage)b));
		else if(a instanceof AnyEvImage && b instanceof AnyEvImage)
			lastOutput.put("C", new EvOpImageMaxImage().exec1Untyped((AnyEvImage)a,(AnyEvImage)b));
		else
