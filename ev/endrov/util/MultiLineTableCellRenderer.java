...
/**
 * Multiline Table Cell Renderer. Example found from
...
public class MultiLineTableCellRenderer extends JTextArea implements TableCellRenderer
	...
	/**
	 * Calculate the new preferred height for a given row, and sets the height on
	 * the table.
	 */
	private void adjustRowHeight(JTable table, int row, int column)
		...
		// to the
		// textarea. The reason for this is that getPreferredSize(), without a width
		// tries
