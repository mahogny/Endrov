 ...
 *
 */
public class FlowUnitRotateImage2D extends FlowUnitBasic
	{
	public static final String showName="Rotate image 2D";
	private static final String metaType="rotateImage2D";
	
	public static void initPlugin() {}
	static
		{
		Flow.addUnitType(new FlowUnitDeclaration(CategoryInfo.name,showName,metaType,FlowUnitRotateImage2D.class, null,
	...
	public void evaluate(Flow flow, FlowExec exec) throws Exception
		...
		lastOutput.put("out", new EvOpRotateImage2D(rotx,roty).exec1Untyped(a));
		}
