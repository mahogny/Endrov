...
import endrov.annotationLineage.Lineage.MeshRenderMode;
import endrov.annotationLineage.util.LineageVoronoi;
import endrov.annotationMesh3d.Mesh3D;
import endrov.annotationMesh3d.Mesh3dModelExtension;
import endrov.core.*;
	...
	static class NucModelWindowHook implements Viewer3DHook, ActionListener, Viewer3DMouseListener
		...
		public void actionPerformed(ActionEvent e)
			...
			if(e.getSource()==miShowSelectedNuc)
				{
				for(endrov.annotationLineage.LineageSelParticle p:LineageCommonUI.getSelectedParticles())
