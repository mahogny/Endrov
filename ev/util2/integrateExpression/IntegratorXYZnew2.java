 ...
 *
 */
public class IntegratorXYZnew2 implements Integrator
	{
	...
	public IntegratorXYZnew2(IntExp integrator, String newLinName,
		...
		for (int i = 0; i<numSubDiv; i++)
			for (int j = 0; j<numSubDiv; j++)
				for (int k = 0; k<numSubDiv; k++)
					{
					NucLineage.Nuc nuc=lin.getCreateNuc("xyz_"+i+"_"+j+"_"+k);
					nuc.pos.clear();
					nuc.exp.clear();
					}
