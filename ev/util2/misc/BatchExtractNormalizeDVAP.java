...
public class BatchExtractNormalizeDVAP
	...
	public static void calcAP(File file, BufferedWriter gnufile, BufferedWriter htmlfile, BufferedWriter rotfile, 
		...
		try
			...
			OstImageset ost=new OstImageset(new File(file.getPath()));
